...
def main():
    pipeline = FisheriesCleaningPipeline(
        ...
        output_dir=BASE_DIR / "public" / "fisheriesdata"
    )
    ...
    if success:
        ...
        print(f" Cleaned files saved to: public/fisheriesdata/")
    else:
...
DashboardGenerator(
    data_dir=BASE_DIR / "public" / "fisheriesdata",
    output_dir=BASE_DIR / "public" / "chartcomponent"
).generate()