...
export default function Map({
    ...
    const getColor = (value: number) => {
        if (value > q4) return "#7f2704";
        if (value > q3) return "#d94801";
        if (value > q2) return "#fd8d3c";
        if (value > q1) return "#fdae6b";
        return "#fdd0a2";
    };
            ...
            <GeoJSON
                ...
                onEachFeature={(feature, layer) => {
                    ...
                    <div style="font-size:13px">
                        ...
                        Non-Commercial Exchange Value: ${formatCurrency(value)}<br/>
